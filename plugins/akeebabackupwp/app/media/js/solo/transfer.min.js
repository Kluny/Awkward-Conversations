...
akeeba.Transfer.onUrlChange=function(a){void 0===a&&(a=!1);var b=document.getElementById("akeeba-transfer-url"),c=b.value;""==c&&(document.getElementById("akeeba-transfer-lbl-url").style.display="block");"http://"!=c.substring(0,7)&&"https://"!=c.substring(0,8)&&(c="http://"+c);if(a||c!==akeeba.Transfer.lastUrl){a=document.querySelectorAll("#akeeba-transfer-row-url > div");for(i=0;i<a.length;i++)a[i].style.display="none";b.setAttribute("disabled","disabled");document.getElementById("akeeba-transfer-btn-url").setAttribute("disabled",
"disabled");document.getElementById("akeeba-transfer-loading").style.display="inline-block";akeeba.System.doAjax({task:"checkUrl",url:c},akeeba.Transfer.applyUrlCheck,function(a){b.removeAttribute("disabled");document.getElementById("akeeba-transfer-btn-url").removeAttribute("disabled");document.getElementById("akeeba-transfer-loading").style.display="none"},!1,1E4);return!1}akeeba.Transfer.applyUrlCheck({status:akeeba.Transfer.lastResult,url:akeeba.Transfer.lastUrl})};
...
"grid",document.getElementById("akeeba-transfer-chunkmode").parentNode.style.display="grid",document.getElementById("akeeba-transfer-chunksize").parentNode.style.display="grid");if("manual"===a)document.getElementById("akeeba-transfer-btn-apply").parentNode.style.display="none",document.getElementById("akeeba-transfer-manualtransfer").style.display="grid";else{if("ftp"===a||"ftps"===a||"ftpcurl"===a||"ftpscurl"===a)document.getElementById("akeeba-transfer-ftp-passive-container").style.display="grid";
if("ftpcurl"===a||"ftpscurl"===a)document.getElementById("akeeba-transfer-ftp-passive-fix-container").style.display="grid";if("sftp"===a||"sftpcurl"===a)document.getElementById("akeeba-transfer-ftp-pubkey").parentNode.style.display="grid",document.getElementById("akeeba-transfer-ftp-privatekey").parentNode.style.display="grid"}};
...
1:0,privateKey:document.getElementById("akeeba-transfer-ftp-privatekey").value,publicKey:document.getElementById("akeeba-transfer-ftp-pubkey").value,chunkMode:document.getElementById("akeeba-transfer-chunkmode").value,chunkSize:document.getElementById("akeeba-transfer-chunksize").value},akeeba.System.doAjax(a,function(a){document.getElementById("akeeba-transfer-apply-loading").style.display="none";if(a.status)akeeba.Transfer.uploadKickstart();else{document.getElementById("akeeba-transfer-btn-apply").removeAttribute("disabled");
document.getElementById("akeeba-transfer-ftp-method").removeAttribute("disabled");var c=document.getElementById("akeeba-transfer-ftp-error"),b=document.getElementById("akeeba-transfer-ftp-error-body"),d=document.getElementById("akeeba-transfer-ftp-error-force");d&&(d.style.display="none",a.ignorable&&(d.style.display="inline-block"));b.innerHTML=a.message;c.style.display="block";akeeba.System.triggerEvent(c,"focus");akeeba.Transfer.onTransferMethodChange()}},function(a){document.getElementById("akeeba-transfer-apply-loading").style.display=
"none";document.getElementById("akeeba-transfer-btn-apply").removeAttribute("disabled");document.getElementById("akeeba-transfer-ftp-method").removeAttribute("disabled");a=document.getElementById("akeeba-transfer-ftp-error");document.getElementById("akeeba-transfer-ftp-error-body").textContent=akeeba.Transfer.translations.COM_AKEEBA_CONFIG_DIRECTFTP_TEST_FAIL;a.style.display="block";akeeba.System.triggerEvent(a,"focus");akeeba.Transfer.onTransferMethodChange()},!1,15E3))};
akeeba.Transfer.uploadKickstart=function(){var a=document.getElementById("akeeba-transfer-upload-lbl-kickstart"),b=document.getElementById("akeeba-transfer-upload-lbl-archive"),c=document.getElementById("akeeba-transfer-upload-error"),f=document.getElementById("akeeba-transfer-upload-error-body"),d=document.getElementById("akeeba-transfer-upload-error-force");c.style.display="none";d.style.display="none";f.innerHTML="";a.className="akeeba-label--orange";b.className="akeeba-label--grey";document.getElementById("akeeba-transfer-upload-area-kickstart").style.display=
"none";document.getElementById("akeeba-transfer-upload-area-upload").style.display="block";document.getElementById("akeeba-transfer-upload").style.display="block";akeeba.System.doAjax({task:"initialiseUpload"},function(e){e.status?akeeba.Transfer.uploadArchive(1):(d&&(d.style.display="none",e.ignorable&&(d.style.display="inline-block")),a.className="akeeba-label--red",f.innerHTML=e.message,c.style.display="block")},null,!1,15E4)};
akeeba.Transfer.uploadArchive=function(a){void 0===a&&(a=0);var b=document.getElementById("akeeba-transfer-upload-lbl-kickstart"),c=document.getElementById("akeeba-transfer-upload-lbl-archive"),f=document.getElementById("akeeba-transfer-upload-error"),d=document.getElementById("akeeba-transfer-upload-error-body");d.innerHTML="";f.style.display="none";b.className="akeeba-label--green";c.className="akeeba-label--orange";akeeba.System.doAjax({task:"upload",start:a},function(a){if(a.result)if(a.done){document.getElementById("akeeba-transfer-upload-percent").textContent=
"100 %";document.getElementById("akeeba-transfer-upload-size").innerHTML="";document.getElementById("akeeba-transfer-upload-area-kickstart").style.display="block";document.getElementById("akeeba-transfer-upload-area-upload").style.display="none";var b=document.getElementById("akeeba-transfer-url").value.replace(/\/$/,"")+"/kickstart.php";document.getElementById("akeeba-transfer-upload-btn-kickstart").setAttribute("href",b)}else{b=0;var e=1*a.totalSize;a=1*a.doneSize;0<e&&0<a&&(b=a/e*100);document.getElementById("akeeba-transfer-upload-percent").textContent=
b.toFixed(2)+"%";document.getElementById("akeeba-transfer-upload-size").textContent=a.toFixed(0)+" / "+e.toFixed(0)+" bytes";window.setTimeout(function(){akeeba.Transfer.uploadArchive(0)},50)}else c.className="akeeba-label--red",d.innerHTML=a.message,f.style.display="block"},null,!1,15E4)};
...
akeeba.System.documentReady(function(){akeeba.System.addEventListener(document.getElementById("akeeba-transfer-ftp-method"),"change",akeeba.Transfer.onTransferMethodChange)}); //# sourceMappingURL=transfer.min.map
